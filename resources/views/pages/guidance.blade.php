    ...
    <div>
        ...
        <div class="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
            ...
            <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
                <a href="/" class="flex h-16 flex-shrink-0 items-center bg-gray-800 px-4">
                ...
                <div class="py-6">
                    ...
                    <section class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                        ...
                        <div class="py-4 px-4">
                            ...
                            <img src="{{ asset('storage/guide/Galon Mart-guide.jpg') }}" />
                            <div align="center" class="flex justify-center py-4">
                                ...
                                <img src="https://img.shields.io/badge/laravel-%5E9.x-blue?logo=laravel"
                                    class="ml-3">
                                <img src="https://img.shields.io/badge/livewire-%5E2.x-blue?logo=livewire"
                                    class="ml-3">
                                <img src="https://img.shields.io/badge/tailwind%20CSS-%5E3.x-blue?logo=tailwindcss"
                                    class="ml-3">
                                <img src="https://img.shields.io/badge/release-1.0.0-success?logo=github"
                                    class="ml-3">
                            </div>
                            <p class="pt-4">Welcome to Galon Mart documentation!</p>

                            <p> This page will guide you step by step to install and set up an online store
                                with the Galon Mart platform. You will also learn how to manage your store with the
                                admin dashboard.</p>

                            <p>If you have any diffeculties please do not hesitate to email us via support@Galon Mart.biz,
                                and we will try our best to help you out!</p>
                        </div>
                    ...
                    <section class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            <ul class="list-decimal px-4">
                                ...
                                <li>
                                    ...
                                    <p>Three different website themes
                                        (Basic, Modern, and Lite). Basic is the default theme.
                                    </p>
                                    </p>
                                </li>
                            </ul>
                        ...
                        <div id="devlopers" class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                            ...
                            <ul class="list-decimal px-4">
                                ...
                                <li>Blog sidebar and search component</li>
