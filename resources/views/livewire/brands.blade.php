<div class="bg-gray-50" x-data="{ categoryMenu: false, brandMenu: true, mobileFilter: false, categoryMobileFilter: false, brandMobileFilter: false }">
    <x-mobile-filters />
    ...
    <main class="screen">
        <div class="flex items-center justify-between pt-6 pb-2 border-b border-gray-200">
            <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{{ __('Brands') }}</h1>
