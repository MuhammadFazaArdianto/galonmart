<div>
    <ul role="list" class="flex items-center mt-2 space-x-6 rtl:space-x-reverse">
        <li>
        ...
        <li>
            <a target="__blank" href="{{ 'https://www.facebook.com/sharer/sharer.php?u=' . $data }}"
        ...
        <li>
            <a target="__blank" href="{{ 'https://twitter.com/intent/tweet?url=' . $data }}"
                title="{{ $this->product->getTranslation('name', App::getLocale()) }}"
                rel='nofollow noopener noreferrer'
        ...
        <li>
            <a target="__blank" href="{{ 'https://wa.me/?text=' . $data }}"
                title="{{ $this->product->getTranslation('name', App::getLocale()) }}"
                rel='nofollow noopener noreferrer'
