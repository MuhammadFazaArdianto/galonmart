<div>
    <div class="border-b bg-white px-4 shadow sm:hidden">
        <div class="flex h-16 justify-between">
            <div class="-mr-2 flex w-full items-center justify-between">
                ...
                <button x-on:click="mobileMenu = ! mobileMenu" type="button"
                    ...
                    <svg x-show="!mobileMenu" class="block h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16" />
                    </svg>
                    <svg x-show="mobileMenu" style="display:none" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg"
    ...
    <div x-show="mobileMenu" style="display:none" class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 pt-2 pb-3 text-base font-medium text-gray-500">
            <!-- Current: "bg-indigo-50 border-indigo-500 text-indigo-700", Default: "border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700" -->
            <a href="/"
                class="block border-indigo-500 bg-indigo-50 py-2 text-base font-medium text-indigo-700 ltr:border-l-4 ltr:pl-3 ltr:pr-4 rtl:border-r-4 rtl:pl-4 rtl:pr-3">
                {{ __('Home') }}
            </a>
            <a href="{{ route('products') }}"
                class="block border-transparent py-2 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700 ltr:border-l-4 ltr:pl-3 ltr:pr-4 rtl:border-r-4 rtl:pl-4 rtl:pr-3">
                {{ __('Products') }}
            </a>
            ...
            <div class="mt-1 flex space-x-4 divide-x-2 border-t px-3 pt-2 rtl:space-x-reverse rtl:divide-x-reverse">
                <a href="{{ route('language', 'id') }}" class="btn-cancel border-b-4">{{ __('id') }}</a>
            ...
            @else
                <div class="mt-1 grid w-full grid-cols-2 gap-4 border-t px-3 pt-2">
