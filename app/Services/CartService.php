...
class CartService
{
     ...
     * @return void
     */
    public function add($id, $name = [], $slug = [], $price, string $image = '', $quantity, $options = []): void
    {
        $cartItem = $this->createCartItem($id, $name, $slug, $price, $image, $quantity, $options);
     ...
     * @return Illuminate\Support\Collection
     */
    protected function createCartItem($id, array $name, array $slug, string $price, string $image, string $quantity, array $options): Collection
    {
