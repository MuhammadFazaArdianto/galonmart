        ...
        <div
            ...
            <div
                ...
                <button class="absolute top-0 right-0 z-10 w-5 h-5 bg-white rounded-bl focus:outline-none" type="button"
                    wire:click="removePreview{{ $name }}()" x-on:click="isUploading=false">
        ...
        <div
            ...
            <div
                ...
                <button class="absolute top-0 right-0 z-10 w-5 h-5 bg-white rounded-bl focus:outline-none"
                    type="button" wire:click="removePreview{{ $name }}()" x-on:click="isUploading=false">
        ...
        <div class="flex flex-col">
            <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                ...
                <label
                    ...
                    <input type="file" class="hidden" wire:model.defer="{{ $name }}" accept="image/*">
                </label>
                @error('{{ $name }}')
